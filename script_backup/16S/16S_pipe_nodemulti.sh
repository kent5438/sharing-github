...
echo "pigz -cd -p 32 ${i}_L001_R2_001.clean.fastq.gz > $i.R2.clean.fastq" ; 
...
perl MiSeq16Sanalysis_pipeline.v3v4cutadapt.pl -p V3FV4R_primer_V3V4.alignseq -s SampleName_16S.txt -r Y -o Y -i Y 2>&1 | tee -a MiSeq16Sanalysis_pipeline.v3v4.log
