...
#	system("cp /export/EC1680U/Pipeline/16S/V3V4_primer.fa primer.fa");
	system("cp /export/EC1680U/perl/bin/16S/16s.illumina.v3.nf ../");
	system("cp /export/EC1680U/perl/bin/16S/16.config ../");
...
#	system("for i in `ls *.fastq | cut -d'.' -f1`; do \
	...
	system("cp /export/EC1680U/perl/bin/16S/16s.PacBio.nf ../");
