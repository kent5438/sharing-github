...
<a href="files/0_ReadQC/multiqc_fastqc.html" target="_blank">QC Summary</a>

```{r, out.width = "700px", out.height="800px", echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_url("files/0_ReadQC/multiqc_fastqc.html")
```
...
<a href="files/1_AssemblyStats/Trinity.95.fasta" target="_blank">Clustered Transcripts by 95% similarity (.fasta)</a>
