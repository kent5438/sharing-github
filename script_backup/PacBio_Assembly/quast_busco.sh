...
. activate quast
quast -t 32 ${prefix}.scaffolds.polished.fasta

echo "### Assembly evaluation by BUSCO..." | ts '[%Y-%m-%d %H:%M:%S]'
. activate busco
run_BUSCO.py -i ${prefix}.scaffolds.polished.fasta -o busco -m geno -l ${busco_db} -t /home/kentchen/tmp -f -c 32 --blast_single_core
...
rsync -avq ../${prefix}.scaffolds.polished.fasta 02_Assembly
