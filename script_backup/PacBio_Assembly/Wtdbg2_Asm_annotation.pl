...
system("sed -i 's/<prefix>/$prefix/g' report_template_wtdbg2/annotation.Rmd");
system("sed -i 's/<prefix>/$prefix/g' report_template_wtdbg2/tools.Rmd");
system("Rscript /export/EC1680U/Pipeline/Pacbio_Denovo/report_template_wtdbg2/build_site.R");
