...
if (genome == "arabidopsis") {
  gen.kegg <- enrichKEGG(gen.entrzid$TAIR, organism = species, pvalueCutoff  = 0.1, qvalueCutoff  = 0.1, pAdjustMethod="BH")
} else {
  gen.kegg <- enrichKEGG(gen.entrzid$ENTREZID, organism = species, pvalueCutoff  = 0.1, qvalueCutoff  = 0.1, pAdjustMethod="BH")
}
