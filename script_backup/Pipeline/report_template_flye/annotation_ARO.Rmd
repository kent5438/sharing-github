...
[Protein Function Table Download (.xlsx)](files/<prefix>_func_anno.xlsx): <--- Functional Full Table
...
### CARD: High Relevance Drug Class (Strict & Perfect)

<a href="files/4_Annotation/drug_class.sig.plotly.html" target="_blank">Drug Class</a>

```{r, out.width = "700px", out.height="800px", echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_url("files/4_Annotation/drug_class.sig.plotly.html")
```

<br>

### CARD: High Relevance Resistance Mechanism (Strict & Perfect)

<a href="files/4_Annotation/resistance_mechanism.sig.plotly.html" target="_blank">Resistance Mechanism</a>

```{r, out.width = "700px", out.height="800px", echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_url("files/4_Annotation/resistance_mechanism.sig.plotly.html")
```

<br>

### CARD: High Relevance AR Gene Family (Strict & Perfect)

<a href="files/4_Annotation/AR_family.sig.plotly.html" target="_blank">AR Family</a>

```{r, out.width = "700px", out.height="800px", echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_url("files/4_Annotation/AR_family.sig.plotly.html")
```
...
[Function Annotation Full Table](files/<prefix>_func_anno.xlsx): <--- Functional Full Table
