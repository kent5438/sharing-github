...
raw_polished_report <- read.table("files/1_Assembly/quast_raw/report.tsv", sep = '\t', header=T, row.names=1, check.names=F)
...
### HGAP Raw Assembly Contig v.s. Quality (HGAP)
...
### Fixed and Circularised Polished Assembly Summary (HGAP)

[Fixed and circularised contigs (.fasta)](files/3_Prokka/<prefix>.fna)

<a href="files/1_Assembly/quast_circ/report.html" target="_blank">[Assembly Report by QUAST (.html)]</a>

```{r, echo=FALSE, message=FALSE, warning=FALSE}
fixed_polished_report <- read.table("files/1_Assembly/quast_circ/report.tsv", header=T, check.names=F, sep="\t")
...
### HGAP Raw Assembled Contigs Coverage vs Quality
