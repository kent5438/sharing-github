...
system("rsync -avq multiqc_* $report_dir/$qc_dir");
...
system("rsync -avq -m --include='*.xlsx' --include='scatter*' --include='*.png' --include='scatter*/***' --include='*.pdf' --include='*/' --exclude='*' $diff_dir $report_dir");
system("rsync -avq -m --include='*.xlsx' --include='*.pdf' --include='*.png' --include='*.xls' --include='*.txt' --include='*/' --exclude='*' $anno_dir $report_dir");
system("rsync -avq --exclude='Trinity.95.fasta.transdecoder_dir' $anno_dir/transdecoder/* $report_dir/$anno_dir/Gene_prediction");
