...
#system("$gffread $anno_dir/transdecoder/Trinity.95.fasta.transdecoder.gff3 -T -o $anno_dir/transdecoder/Trinity.95.fasta.transdecoder.gtf");
...
#my $blastx_cmd = "blastx -query $stat_dir/Trinity.95.fasta -db $uniDB ".
...
#my $blastp_cmd = "blastp -query $anno_dir/transdecoder/Trinity.95.fasta.transdecoder.pep -db $uniDB ".
#"-db $nrDB -gilist $gilist ".
...
# rnammer (no conda package!)
my $rnammer_cmd = "RnammerTranscriptome.pl --transcriptome $stat_dir/Trinity.95.fasta --org_type $kingdom ".
...
my $go_slim_mapping = "Trinotate_GO_to_SLIM.pl $go_dir/Trinotate_report.xls.gene_ontology > $go_dir/GO_slim_mapping.txt";
