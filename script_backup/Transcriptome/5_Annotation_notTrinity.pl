...
my $blastx_cmd = "nextflow run /export/EC1680U/perl/bin/Trinity/blastx.nf -resume";
my $blastp_cmd = "nextflow run /export/EC1680U/perl/bin/Trinity/blastp.nf -resume";
...
my $hmmer_cmd = "nextflow run /export/EC1680U/perl/bin/Trinity/hmmscan.nf -resume";
