...
system("sed -i 's/<prefix>/$prefix/g' report_template_canu/annotation.Rmd");
system("sed -i 's/<prefix>/$prefix/g' report_template_canu/tools.Rmd");
system("Rscript /export/EC1680U/Pipeline/Pacbio_Denovo/report_template_canu/build_site.R");
