...
my $nrDB = "/export/EC1680U/DataBase/Uniprot/Bacteria/M_tuberculosis-taxonomy_1773.fasta";
...
system("sed -i 's/<prefix>/$prefix/g' report_template/annotation_ARO.Rmd");
system("sed -i 's/<prefix>/$prefix/g' report_template/tools.Rmd");
system("Rscript /export/EC1680U/Pipeline/Miseq_Assembly/build_site_ARO.R");
